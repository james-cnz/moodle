...
if (!is_null($returnpagelevel)) {
    $params['returnpagelevel'] = $returnpagelevel;
...
if ($deletesection) {
    ...
    if (course_can_delete_section($course, $sectioninfo)) {
        ...
        if ($confirm) {
            ...
            redirect($returnoptions ? $courseurl : $returnurl);
        } else {
...
if ($mform->is_cancelled()){
    ...
    redirect($returnoptions ? course_get_url($course, $section, $returnoptions) : $returnurl);
