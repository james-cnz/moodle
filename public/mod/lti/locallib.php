 ...
 *      Alternatively just the section number of the page to return to or null (deprecated since Moodle 5.3)
...
function lti_get_configured_types($courseid, $returnoptions = []) {
    ...
    foreach ($preconfiguredtypes as $ltitype) {
        ...
        if (is_numeric($returnoptions)) {
            debugging(
                'The lti_get_configured_types 2nd parameter as numeric is deprecated. Please pass return options array.',
                DEBUG_DEVELOPER,
            );
            $returnoptions = ['sr' => $returnoptions];
        } else if (is_null($returnoptions)) {
            debugging(
                'The lti_get_configured_types 2nd parameter as null is deprecated. Please pass return options array.',
                DEBUG_DEVELOPER,
            );
            $returnoptions = [];
        }
