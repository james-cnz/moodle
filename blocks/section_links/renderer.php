    ...
    public function render_section_links(stdClass $course, array $sections, $jumptosection = false, $showsectionname = false) {
        ...
        foreach ($sections as $section) {
            ...
            $html .= html_writer::link(
                course_get_url($course, $section->section, ['navigation' => true, 'pagelevel' => null]),
                $sectiontext,
                $attributes
            );
        ...
        if ($jumptosection && isset($sections[$jumptosection])) {
            ...
            $html .= html_writer::link(
                course_get_url($course, $jumptosection, ['navigation' => true, 'pagelevel' => null]), $linktext, $attributes
            );
        }
