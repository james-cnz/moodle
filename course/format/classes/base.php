...
abstract class base {
    ...
    /**
     * Get what level of page is displayed.
     *
     ...
     *     'pagelevel' (int) the level of page to display
    ...
    public function get_view_url($section, $options = []) {
        ...
        $pagelevel = $options['pagelevel'] ?? PAGE_LEVEL_COURSE;
        ...
        if (!array_key_exists('pagelevel', $options) && !array_key_exists('pagesectionid', $options)) {
            if (array_key_exists('navigation', $options)) {
                $pagelevel = $options['navigation'] ? PAGE_LEVEL_SPECIFIED : PAGE_LEVEL_COURSE;
            }
    ...
    public function inplace_editable_render_section_name($section, $linkifneeded = true,
        ...
        if ($linkifneeded) {
            ...
            $url = course_get_url($section->course, $section);
            if ($url) {
