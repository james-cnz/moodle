...
export default class extends DndSection {
     ...
     *
     * @deprecated since Moodle 4.5.5 and 5.0.1, see MDL-85379.
     * @todo MDL-85381 This will be deleted in Moodle 6.0.
     */
    async _openSectionIfNecessary() {
        log.debug("section _openSectionIfNecessary() is deprecated.  Use content _openSectionsIfNecessary() instead.");
