...
export default class Component extends BaseComponent {
    ...
    create(descriptor) {
        ...
        this.sectionReturn = descriptor?.sectionReturn ?? null; // Deprecated since Moodle 5.0, see MDL-83857.
     ...
     * @param {number} sectionReturn the section number of the displayed page.  Deprecated since Moodle 5.0, see MDL-83857.
     * @param {number} [pageSectionId] the section ID of the displayed page
     * @return {Component}
     */
    static init(target, selectors, sectionReturn, pageSectionId = null) {
