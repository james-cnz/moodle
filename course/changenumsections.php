...
$pagesectionid = optional_param('pagesectionid', null, PARAM_INT); // The page to return to, ignored if $returnurl is specified.
$pagelevel = optional_param('pagelevel', null, PARAM_INT);         // Alternatively, the page level to return to (PAGE_LEVEL_*),
                                                                   // ignored if $returnurl is specified.
